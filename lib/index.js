...
exports.register = function (server, opts, next) {
    ...
    const logSettingValues = {
        trace: { trace: true, warn: true, error: true, debug: true, info: true },
        warn: { trace: false, warn: true, error: true, debug: true, info: true },
        error: { trace: false, warn: false, error: true, debug: true, info: true },
        debug: { trace: false, warn: false, error: false, debug: true, info: true },
        info: { trace: false, warn: false, error: false, debug: false, info: true }
    };
    if (settingsPath) {
